    ...
    <section className="ui-surface overflow-hidden">
      <div className="grid gap-5 p-5 lg:grid-cols-[1.1fr_0.9fr]">
        ...
        <div className="rounded-lg border border-border-soft bg-surface-soft p-3">
          <div className="relative min-h-64 overflow-hidden rounded-lg bg-[radial-gradient(circle_at_center,#ffffff_0,#f1f4ee_42%,#e8f3ea_100%)]">
            <div className="absolute left-1/2 top-1/2 size-24 -translate-x-1/2 -translate-y-1/2 rounded-full border border-primary/20" />
            <div className="absolute left-1/2 top-1/2 size-40 -translate-x-1/2 -translate-y-1/2 rounded-full border border-primary/15" />
            <div className="absolute left-1/2 top-1/2 size-56 -translate-x-1/2 -translate-y-1/2 rounded-full border border-primary/10" />
            <div className="absolute left-1/2 top-1/2 z-10 size-4 -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary shadow-[0_0_0_8px_rgba(47,125,58,0.14)]" />
            ...
            {listings.slice(0, 3).map((item, index) => {
              ...
              return (
                <Link
                  className={`absolute ${pointPositions[index]} group z-20 flex max-w-40 items-start gap-2 rounded-lg border border-border-soft bg-white/95 p-2 text-left shadow-sm transition hover:-translate-y-0.5 hover:border-primary`}
